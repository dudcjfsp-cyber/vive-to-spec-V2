...
export function buildRegenerateStartedShadowPayload({
  clarificationAnswersPatch = null,
  clarifyQuestions = [],
  nextLoopTurn = 0,
  apiProvider = '',
  ...
  return {
    ...
    currentNodeId: 'regenerate_started',
    clarificationAnswersPatch,
    pendingQuestions: clarifyQuestions,
    loopTurn: nextLoopTurn,
    payload: {
...
export function buildRegenerateErrorShadowPayload({
  clarificationAnswersPatch = null,
  clarifyQuestions = [],
  nextLoopTurn = 0,
  apiProvider = '',
  ...
  return {
    ...
    currentNodeId: 'regenerate_error',
    clarificationAnswersPatch,
    pendingQuestions: clarifyQuestions,
    loopTurn: nextLoopTurn,
    payload: {
